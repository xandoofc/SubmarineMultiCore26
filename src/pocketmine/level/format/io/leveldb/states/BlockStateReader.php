...
final class BlockStateReader
{
	...
	public function missingOrWrongTypeException(string $name, ?NamedTag $tag) : BlockStateDeserializeException
	{
	...
	{
		return $this->readInt(BlockStateNames::FACING_DIRECTION);
	}
	...
	{
		return $this->readInt(BlockStateNames::WEIRDO_DIRECTION);
	}

	/** @throws BlockStateDeserializeException */
	public function readLegacyHorizontalFacing() : int
	{
		return $this->readInt(BlockStateNames::DIRECTION);
	}
	...
	/** @throws BlockStateDeserializeException */
	public function readSlabTop() : bool
	{
		return match($rawValue = $this->readString(BlockStateNames::MC_VERTICAL_HALF)) {
			StringValues::MC_VERTICAL_HALF_BOTTOM => false,
			StringValues::MC_VERTICAL_HALF_TOP => true,
	...
	/** @throws BlockStateDeserializeException */
	public function readWallConnectionType(string $name) : ?string
	{
		return match($type = $this->readString($name)) {
			...
			StringValues::WALL_CONNECTION_TYPE_EAST_SHORT => StringValues::WALL_CONNECTION_TYPE_EAST_SHORT,
			StringValues::WALL_CONNECTION_TYPE_EAST_TALL => StringValues::WALL_CONNECTION_TYPE_EAST_TALL,
