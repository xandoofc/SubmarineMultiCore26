...
final class CommandArgumentTypeIds370
{
	...
	public const ARG_TYPE_POSITION = 0x23;

	public const ARG_TYPE_MESSAGE = 0x27;

	public const ARG_TYPE_RAWTEXT = 0x29;

	public const ARG_TYPE_JSON = 0x2c;

	public const ARG_TYPE_COMMAND = 0x33;
