...
class ProtocolConvertor
{
	...
	private const array PROTOCOL_CHUNK_VERSIONS = [
	...
	private const array PROTOCOL_CRAFTING_VERSIONS = [
		ProtocolInfo::PROTOCOL_827,
	...
	private const array PROTOCOL_BLOCK_PALETTE_VERSIONS = [
		ProtocolInfo::PROTOCOL_975,
		ProtocolInfo::PROTOCOL_844,
		ProtocolInfo::PROTOCOL_827,
		ProtocolInfo::PROTOCOL_800,
	...
	private const array PROTOCOL_ITEM_PALETTE_VERSIONS = [
		ProtocolInfo::PROTOCOL_975,
		ProtocolInfo::PROTOCOL_827,
		ProtocolInfo::PROTOCOL_818,
		ProtocolInfo::PROTOCOL_800,
	...
	private const PROTOCOL_ITEM_LEGACY_VERIONS = [
		ProtocolInfo::PROTOCOL_975,
		ProtocolInfo::PROTOCOL_827,
		ProtocolInfo::PROTOCOL_818,
		ProtocolInfo::PROTOCOL_800,
	...
	{
		foreach (self::PROTOCOL_ITEM_LEGACY_VERIONS as $protocol) {
			if ($playerProtocol >= $protocol) {
				return $protocol;
			}
		}
	...
	private const PROTOCOL_BLOCK_LEGACY_VERIONS = [
		ProtocolInfo::PROTOCOL_827,
		ProtocolInfo::PROTOCOL_800,
		ProtocolInfo::PROTOCOL_786,
		ProtocolInfo::PROTOCOL_766,
	...
	{
		foreach (self::PROTOCOL_BLOCK_LEGACY_VERIONS as $protocol) {
			if ($playerProtocol >= $protocol) {
				return $protocol;
			}
		}
	...
	private const PROTOCOL_MAP_VERSIONS = [
		ProtocolInfo::PROTOCOL_544,
		ProtocolInfo::PROTOCOL_354,
	...
	{
		foreach (self::PROTOCOL_MAP_VERSIONS as $protocol) {
			if ($playerProtocol >= $protocol) {
				return $protocol;
			}
		}
