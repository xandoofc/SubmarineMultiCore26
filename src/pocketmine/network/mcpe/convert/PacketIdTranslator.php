...
class PacketIdTranslator {
	...
	private static function make() : self{
		return new self([
			ProtocolInfo::PROTOCOL_975 => ProtocolInfo818::class,
			ProtocolInfo::PROTOCOL_944 => ProtocolInfo818::class,
			ProtocolInfo::PROTOCOL_924 => ProtocolInfo818::class,
			ProtocolInfo::PROTOCOL_898 => ProtocolInfo818::class,
			ProtocolInfo::PROTOCOL_860 => ProtocolInfo818::class,
			ProtocolInfo::PROTOCOL_859 => ProtocolInfo818::class,
			ProtocolInfo::PROTOCOL_844 => ProtocolInfo818::class,
