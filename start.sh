...
if [ "$PHP_BINARY" == "" ]; then
	if [ -f ../SubmarineMultiCore/bin/php7/bin/php ]; then
		export PHPRC="../SubmarineMultiCore/bin/php7/bin"
		PHP_BINARY="../SubmarineMultiCore/bin/php7/bin/php"
	elif [ -f ./bin/php7/bin/php ]; then
		export PHPRC=""
		PHP_BINARY="./bin/php7/bin/php"
	elif [ -f ./bin/php7/bin/php7/bin/php ]; then
		export PHPRC=""
		PHP_BINARY="./bin/php7/bin/php7/bin/php"
	elif [[ -n $(type php 2> /dev/null) ]]; then
		PHP_BINARY=$(type -p php)
	else
		echo "Couldn't find a PHP binary in system PATH, $PWD/bin/php7/bin/php or $PWD/bin/php7/bin/php7/bin/php"
